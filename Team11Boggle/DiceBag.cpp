...
#pragma region Constructors
	...
	/// <summary>
	/// A Constructor that creates a DiceBag and fills it with dice.
	/// </summary>
	DiceBag::DiceBag()
	{
...
#pragma region Functions
	...
	/// <summary>
	/// Gets a random Die from the DiceBag.
	/// </summary>
	/// <returns>A random Die from the DiceBag.</returns>
